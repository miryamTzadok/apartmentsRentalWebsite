...
const nav=useNavigate()
    ...
    const handleSubmit = () => {
        ...
        // const apartment = {
        //     advertiserId: localStorage.getItem('currentUser'),
        //     price: priceRef.current.value,
        //     additives: additivesRef.current.value,
        //     numOfBeds: numOfBedsRef.current.value,
        //     address: addressRef.current.value,
        //     cityId: selectedCategory,
        //     categoryId: selectedCity,
        //     image: imageRef.current.value,
        //     description: descriptionRef.current.value,
        //     apartmentName: apartmentNameRef.current.value
    ...
    return (
        ...
        <animated.div style={{ ...springProps, position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0, 0, 0, 0.5)' ,zIndex:200}}>
            ...
            <div className="login-box" style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', background: 'white', padding: '20px', borderRadius: '8px', backgroundColor: '   rgba(0,0,0,.5)' }}>
                ...
                <form onSubmit={handleSubmit} action="">
                    ...
                    {/* <div className="user-box">
        <input type="text" name="cityId" ref={apartmentNameRef} required />
        <label>שם הדירה:</label>
    </div> */}
                    <div className="user-box">
